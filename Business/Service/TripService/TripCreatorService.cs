...
using Business.Model.ServiceModel.TripServiceModel.TripReservationService.InternalModel;
using Common;
using Domain.Entity;
    ...
    public class TripCreatorService : ITripCreatorService
    {
        ...
        public ServiceResult<TripCreatorServiceResponseModel> CreateTrip(TripCreatorServiceRequestModel tripCreatorServiceRequestModel)
        {
            ...
            try
            {
                ...
                var tripId = CreateTripInDb(tripCreatorServiceRequestModel);
        ...
        {
            return tripCreatorServiceRequestModel.Routate.Split(',').ToList();
        }

        private TripReservationServiceCreateTripModel CreateTripInDb(TripCreatorServiceRequestModel tripCreatorServiceRequestModel)
        {
            var trip = new Trip();
